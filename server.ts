...
async function startServer() {
  ...
  app.get("/api/products", async (req, res) => {
    try {
      ...
      console.log("Raw Gumroad Products Response:", JSON.stringify(response.data, null, 2));
  ...
  app.delete("/api/products/:id", async (req, res) => {
    try {
      ...
      const response = await axios.delete(`${GUMROAD_API_BASE}/products/${req.params.id}`, {
        params: { access_token: accessToken }
      });
      res.json(response.data);
    } catch (error: any) {
      console.error("Gumroad Delete Product Error:", error.response?.data || error.message);
  ...
  app.post("/api/products/:product_id/variant_categories/:category_id/variants", async (req, res) => {
    try {
      ...
      const response = await axios.post(`${GUMROAD_API_BASE}/products/${req.params.product_id}/variant_categories/${req.params.category_id}/variants`, {
        access_token: accessToken,
        ...req.body
      });
      res.json(response.data);
  ...
  app.post("/api/products/:product_id/offer_codes", async (req, res) => {
    try {
      ...
      const response = await axios.post(`${GUMROAD_API_BASE}/products/${req.params.product_id}/offer_codes`, {
        access_token: accessToken,
        ...req.body
      });
      res.json(response.data);
  ...
  app.post("/api/verify-license", async (req, res) => {
    ...
    try {
      const payload: any = { 
        product_id, 
        license_key, 
        increment_uses_count: increment_uses === true ? "true" : "false" 
      };
      
      const response = await axios.post(`${GUMROAD_API_BASE}/licenses/verify`, payload);
      res.json(response.data);
    } catch (error: any) {
  ...
  app.put("/api/licenses/:license_key/enable", async (req, res) => {
    try {
      ...
      const response = await axios.put(`${GUMROAD_API_BASE}/licenses/enable`, {
        access_token: accessToken,
  ...
  app.put("/api/licenses/:license_key/disable", async (req, res) => {
    try {
      ...
      const response = await axios.put(`${GUMROAD_API_BASE}/licenses/disable`, {
        access_token: accessToken,
        license_key: req.params.license_key,
        product_id: req.body.product_id
      });
  ...
  app.put("/api/licenses/:license_key/decrement-uses", async (req, res) => {
    try {
      ...
      const response = await axios.put(`${GUMROAD_API_BASE}/licenses/decrement_uses_count`, {
        access_token: accessToken,
        license_key: req.params.license_key,
        product_id: req.body.product_id
      });
  ...
  app.put("/api/licenses/:license_key/rotate", async (req, res) => {
    try {
      ...
      const response = await axios.put(`${GUMROAD_API_BASE}/licenses/rotate`, {
        access_token: accessToken,
        license_key: req.params.license_key,
        product_id: req.body.product_id
      });
