...
export function BottomNavBar() {
  ...
  const navItems = [
    ...
    { icon: Sparkles, label: "DASH", path: "/dash-ai", isSpecial: true },
            ...
            >
              ...
              {item.isSpecial ? (
                <div className="ai-space-btn">
                  <img 
                    src={dashMode === 'keyboard' ? KEYBOARD_SVG : LOGO_SRC} 
                    alt="DASH Mode" 
                    className={cn("w-8 h-8 object-contain brightness-0 invert transition-all", dashMode === 'keyboard' && "opacity-90")}
                    referrerPolicy="no-referrer"
                  />
