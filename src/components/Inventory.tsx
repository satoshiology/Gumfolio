...
export default function Inventory() {
  ...
  const totalRevenueFormatted = formatPrice(products.reduce((acc, p) => acc + p.sales_usd_cents, 0), 'USD');
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-8">
            ...
            <div className="flex flex-wrap gap-2 pt-4 border-t border-white/5">
              <button 
                  ...
                  className={cn("px-4 py-2 rounded-lg text-sm font-label font-bold uppercase tracking-wider text-black bg-orange-500")}
              >
              ...
              <HoldButton 
                  ...
                  actionText="Delete"
                  className="px-4 py-2 rounded-lg text-sm font-label font-bold uppercase tracking-wider bg-red-600 text-white flex items-center gap-2"
              >
                  Delete Product
              </HoldButton>
            </div>
