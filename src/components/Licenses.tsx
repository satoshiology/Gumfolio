...
import { Verified, CheckCircle, Loader2, AlertCircle, ShieldAlert, Search, Mail, User as UserIcon, Key as KeyIcon, X, Copy, Settings, RefreshCcw, Power, PowerOff, Plus, Minus } from "lucide-react";
    ...
    >
        <div className="flex justify-between items-start">
            ...
            <button 
                ...
                className="px-4 py-2 rounded-xl text-[10px] font-label font-bold uppercase tracking-widest neuro-button text-on-surface hover:text-primary transition-all duration-300"
                title="Manage"
            >
                Manage
            </button>
        ...
        <div className="grid grid-cols-[1fr_auto] gap-4">
          <div className="bg-black/30 rounded-2xl p-4 border border-white/5 font-mono">
        ...
        <div className="grid grid-cols-2 gap-4 pt-2 border-t border-white/5">
          <div className="space-y-1">
            ...
            <div className="text-on-surface font-headline font-bold text-lg flex items-center gap-2">
                ...
                <button onClick={handleIncrease} className="text-primary hover:text-white p-1 rounded-full"><Plus className="w-4 h-4"/></button>
            </div>
          </div>
          <div className="space-y-1">
