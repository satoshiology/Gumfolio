...
import { Verified, CheckCircle, Loader2, AlertCircle, ShieldAlert, Search, Mail, User as UserIcon, Key as KeyIcon, X, Copy, Settings, RefreshCcw, Power, PowerOff, Plus } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <div className="bg-surface-container/40 p-4 rounded-xl border border-white/5">
            ...
            <div className="flex gap-3">
              ...
              <button 
                disabled={loadingAction !== null}
                onClick={() => setConfirmAction({ name: 'Revoke License', fn: () => ActionRegistry.get("disableLicense")!.execute(sale.product_id, sale.license_key) })}
